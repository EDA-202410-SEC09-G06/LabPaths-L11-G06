...
# Sample Algorithm
<!-- PROJECT SHIELDS -->
[![Contributors][sample-algorithm-contributors-shield]][sample-algorithm-contributors-url]
[![Forks][sample-algorithm-forks-shield]][sample-algorithm-forks-url]
[![Stargazers][sample-algorithm-stars-shield]][sample-algorithm-stars-url]
[![Issues][sample-algorithm-issues-shield]][sample-algorithm-issues-url]
[![License][sample-algorithm-license-shield]][sample-algorithm-license-url]

This is the repository is for the eleventh and last laboratory. It focusses on how to use the different DISCLib Graph’s algorithms, when to use them,  and how to integrate it into the MVC scripts from the course.
...
[DISClib][disclib-url] · [DISClib Demo and Examples][demo-url] · [Report Bug][sample-algorithm-bugs-url] · [Request Feature][sample-algorithm-issues-url]

<!-- PROJECT CONTENT -->
**Table of Contents (up to date)**
<!-- autogenerated by plugin -->

1. [Sample Algorithm](#Sample-Algorithm)
    1. [Members](#Members)
...
1. Alejandro Salcedo, a.salcedo11@uniandes.edu.co, 202321921
1. Samuel Osorio, sd.osorio2@uniandes.edu.co, 202324806
1. Julian Restrepo, j.restrepo112@uniandes.edu.co, 202320177
...
<!-- links for EDA Sample-Algorithm lab repository -->
[sample-algorithm-contributors-shield]: https://img.shields.io/github/contributors/ISIS1225DEVS/ISIS1225-SampleAlgorithm.svg?style=for-the-badge
[sample-algorithm-contributors-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/graphs/contributors
[sample-algorithm-forks-shield]: https://img.shields.io/github/forks/ISIS1225DEVS/ISIS1225-SampleAlgorithm.svg?style=for-the-badge
[sample-algorithm-forks-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/network/members
[sample-algorithm-stars-shield]: https://img.shields.io/github/stars/ISIS1225DEVS/ISIS1225-SampleAlgorithm.svg?style=for-the-badge
[sample-algorithm-stars-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/stargazers
[sample-algorithm-issues-shield]: https://img.shields.io/github/issues/ISIS1225DEVS/ISIS1225-SampleAlgorithm.svg?style=for-the-badge
[sample-algorithm-issues-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/issues
[sample-algorithm-license-shield]: https://img.shields.io/badge/License-GPLv3-blue.svg?style=for-the-badge
[sample-algorithm-license-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/blob/master/LICENSE
[sample-algorithm-bugs-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/issues
[sample-algorithm-issues-url]: https://github.com/ISIS1225DEVS/ISIS1225-SampleAlgorithm/issues